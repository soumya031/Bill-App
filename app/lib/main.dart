          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              return GridView.count(
                ...
                crossAxisSpacing: 14,
                mainAxisSpacing: 14,
                childAspectRatio: narrow ? 1.45 : 1.75,
                children: const [
                  MetricCard(
                      label: 'Total sales',
                      value: '₹8,42,560',
...
class InventoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ModulePage(
        ...
        actionIcon: Icons.add_rounded,
        onAction: () =>
            _showMessage(context, 'Product form is ready for your next item.'),
        child: const DataPanel(lastColumnIsStatus: false, headers: [
          'Product',
          'SKU',
          'Category',
          'Stock',
...
class CustomersPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ModulePage(
        ...
        onAction: () =>
            _showMessage(context, 'Customer form is ready for a new contact.'),
        child: const DataPanel(headers: [
          'Customer',
          'Contact',
          'Invoices',
          'Balance',
...
class CashBankPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ModulePage(
        ...
        actionIcon: Icons.add_rounded,
        onAction: () =>
            _showMessage(context, 'Transaction form is ready to use.'),
        child: const DataPanel(headers: [
          'Description',
          'Account',
          'Date',
          ...
          [
            'Payment from Meera Enterprises',
            'HDFC current',
            '25 Aug 2026',
            '+₹42,800',
            'Income'
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                TextField(
                    decoration: InputDecoration(
                        labelText: 'Customer', hintText: 'Search customer')),
                SizedBox(height: 14),
                TextField(
                    decoration:
          ...
          actions: [
            ...
            FilledButton(
                onPressed: () {
                  ...
                  _showMessage(context, 'Invoice draft created.');
                },
